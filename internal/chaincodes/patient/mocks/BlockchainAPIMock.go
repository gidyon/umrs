...
// ledgerAPIMock is an autogenerated mock type for the ledgerAPIMock type
type ledgerAPIMock struct {
	mock.Mock
}

// AddBlock provides a mock function with given fields: ctx, in, opts
func (_m *ledgerAPIMock) AddBlock(ctx context.Context, in *ledger.AddBlockRequest, opts ...grpc.CallOption) (*ledger.AddBlockResponse, error) {
...
func (_m *ledgerAPIMock) GetBlock(ctx context.Context, in *ledger.GetBlockRequest, opts ...grpc.CallOption) (*ledger.Block, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *ledgerAPIMock) GetStat(ctx context.Context, in *ledger.GetStatRequest, opts ...grpc.CallOption) (*ledger.GetStatResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *ledgerAPIMock) ListBlocks(ctx context.Context, in *ledger.ListBlocksRequest, opts ...grpc.CallOption) (*ledger.Blocks, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *ledgerAPIMock) RegisterContract(ctx context.Context, in *ledger.RegisterContractRequest, opts ...grpc.CallOption) (*ledger.RegisterContractResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
